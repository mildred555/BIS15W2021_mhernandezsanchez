...
**in regards to matrices use them to load data faster? but also if you're only working with one**
```{r}
...
expenditures %>%
  pivot_longer(-expenditure,
               names_to="year",
               values_to="personal_expenditure")
```
...
```{r}
heartrate2 %>% 
  separate(patient, into= c("patient", "sex"), sep = "_") #separating patient into two
```
